...
async execute(message,args,client) {
    ...
    if (!args.length)
      return attentionembed(message,`Utilisation: ${message.client.prefix}${module.exports.name} Nom de la vidéo>`)
    ...
    .setAuthor("En train de chercher", "https://i.redd.it/y3wduhwn4gd61.jpg")
    .setColor("#F0EAD6")
    ...
    let resultsEmbed = new MessageEmbed()
      ...
      .setColor("#F0EAD6")
      .setAuthor("Résultats de recherche!!", "https://1.bp.blogspot.com/-D-e3wLzsOe8/Xv43-XMvYdI/AAAAAAAAHoM/QsKCxztzUzQ649pt-lWAg7STTlsgqxL4QCK4BGAsYHg/d/apple-music-note.jpg")
      .setFooter("Réponse avec votre numéro préféré","https://1.bp.blogspot.com/-D-e3wLzsOe8/Xv43-XMvYdI/AAAAAAAAHoM/QsKCxztzUzQ649pt-lWAg7STTlsgqxL4QCK4BGAsYHg/d/apple-music-note.jpg")
