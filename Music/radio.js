...
module.exports = {
  name: "radio",
  description: "Écouter une station de radio",
  cooldown: 3,
  edesc: `Tapez cette commande pour lire un flux radio en direct !\nUtilisation: ${PREFIX}radio <1-34>`,
...
` , inline: true
        ...
        {
          name: `***🇦🇺 Australie RADIO:***`, value: `**17: ** [\`${Radiostations[17 - 1].split(" ")[0]}\`](${Radiostations[17 - 1].split(" ")[1]})
**18: ** [\`${Radiostations[18 - 1].split(" ")[0]}\`](${Radiostations[18 - 1].split(" ")[1]})`, inline: true
        },

        {
          name: `***🇦🇹 Autriche RADIO:***`, value: `**19: ** [\`${Radiostations[19 - 1].split(" ")[0]}\`](${Radiostations[19 - 1].split(" ")[1]})
...
**22: ** [\`${Radiostations[22 - 1].split(" ")[0]}\`](${Radiostations[22 - 1].split(" ")[1]})`, inline: true
        ...
        {
          name: `***🇮🇹 Italie RADIO:***`, value: `**23: ** [\`${Radiostations[23 - 1].split(" ")[0]}\`](${Radiostations[23 - 1].split(" ")[1]})
**24: ** [\`${Radiostations[24 - 1].split(" ")[0]}\`](${Radiostations[24 - 1].split(" ")[1]})`, inline: true
        },

        {
          name: `***🇪🇪 Estonie RADIO:***`, value: `**25: ** [\`${Radiostations[25 - 1].split(" ")[0]}\`](${Radiostations[25 - 1].split(" ")[1]})
**26: ** [\`${Radiostations[26 - 1].split(" ")[0]}\`](${Radiostations[26 - 1].split(" ")[1]})`, inline: true
        },

        {
          name: `***🇪🇸 Espagne RADIO:***`, value: `**27: ** [\`${Radiostations[27 - 1].split(" ")[0]}\`](${Radiostations[27 - 1].split(" ")[1]})
**28: ** [\`${Radiostations[28 - 1].split(" ")[0]}\`](${Radiostations[28 - 1].split(" ")[1]})`, inline: true
        },

        {
          name: `***🇨🇿 République Tchèque RADIO:***`, value: `**29: ** [\`${Radiostations[29 - 1].split(" ")[0]}\`](${Radiostations[29 - 1].split(" ")[1]})
**30: ** [\`${Radiostations[30 - 1].split(" ")[0]}\`](${Radiostations[30 - 1].split(" ")[1]})`, inline: true
        },

        {
          name: `***🇳🇱 Pays-bas RADIO:***`, value: `**31: ** [\`${Radiostations[31 - 1].split(" ")[0]}\`](${Radiostations[31 - 1].split(" ")[1]})
**32: ** [\`${Radiostations[32 - 1].split(" ")[0]}\`](${Radiostations[32 - 1].split(" ")[1]})`, inline: true
        },

        {
          name: `***🇵🇱 Pologne RADIO:***`, value: `**33: ** [\`${Radiostations[33 - 1].split(" ")[0]}\`](${Radiostations[33 - 1].split(" ")[1]})
**34: ** [\`${Radiostations[34 - 1].split(" ")[0]}\`](${Radiostations[34 - 1].split(" ")[1]})`, inline: true
    ...
    if (!permissions.has("SPEAK"))
      return attentionembed(message, "J'ai besoin d'autorisations pour parler sur votre chaîne");
    ...
    if (isNaN(args[0])) {
      ...
      return message.reply(
        new MessageEmbed()
          .setColor("RED")
          .setTitle(`Pas une station de radio valide, veuillez utiliser un numéro entre \`1\` et \`${Radiostations.length}\``)
      );
    }
    ...
    const song = {
      title: args2[0],
      url: args2[1],
      thumbnail: "https://1.bp.blogspot.com/-D-e3wLzsOe8/Xv43-XMvYdI/AAAAAAAAHoM/QsKCxztzUzQ649pt-lWAg7STTlsgqxL4QCK4BGAsYHg/d/apple-music-note.jpg",
      duration: 10000,
    };
    let a, b;
    if (!serverQueue) {
    ...
    if (!serverQueue)
      message.channel.send(new MessageEmbed().setColor("#F0EAD6")
        .setDescription(`**👍 J'ai rejoins \`${channel.name}\` 📄 Lié \`#${message.channel.name}\`**`)
        .setFooter(`${message.author.username}#${message.author.discriminator}`));
    //send Search something embed
    message.channel.send(new MessageEmbed().setColor("#F0EAD6")
      .setDescription(`**:radio: En train de chercher 🔍 \`${Radiostations[i - 1].split(" ")[0]}\`**`));
    //mute yourself
